...
include 'view_following_coding.php';
...
<html lang="en">
    <head>
        ...
        <title>My Park | Followings</title>
...
xmlhttp.setRequestHeader("Connection", "close");
       ...
       <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <form action="view_following.php" method="POST" class="form-signin">
                ...
                <div class="row">
                    <div class="container ">
                       ...
                       <div class=" col-md-10 col-sm-10 blog-main  col-xs-12 ">
                            <div class="col-md-10 col-md-push-2 col-sm-10 col-sm-push-2  col-xs-12 blog-post">
                               <?php echo $_SESSION['newer_accounts']; ?>
