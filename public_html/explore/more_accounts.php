...
while ($row = $response->fetch_assoc()) {
	...
	$check_follow = mysql_query("SELECT * FROM following WHERE following.following_fld_user_id = $explore_User_id AND following.following_flg_user_id = $user_id");
...
if($explore_User_id == $user_id){
            ...
            echo '<div class="row col-md-10 col-md-push-1  col-sm-10 col-xs-12 table-border ">          
                                    <img class="img-circle pull-left" src="../uploads/images/' . show_pro_pic($explore_User_id) . '" alt="Generic placeholder image" width="40" height="40">
                                    <div class="col-md-8">
                                        <a href="journey_bridge.php?IN_user_id='.$explore_User_id.'" ><h5 class="blog-post-title"><font color="#000">' . $explore_username . '</font></h5></a>
                                               

                                        <p class="blog-post-meta"><font  size="1px">' . $explore_User_name. '  ' . $explore_User_surname . '</font></p>
                                        <div class="col-md-3 col-md-push-5 col-sm-2 col-sm-push-4 col-xs-3 col-xs-push-1 pull-right">                     
