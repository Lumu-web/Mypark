...
$status_posts = "SELECT * FROM status_post WHERE hashtag LIKE '%$hashtag%' order by Status_time DESC $limit";
...
//display posts
                                    ...
                                    if (mysqli_num_rows($check_liked) > 0) {
                                        $like_button = '<img src="../buttons/like_button(red).png" height="20px" width="20px" alt="Generic placeholder " width="10%" height="10%">';
                                    } else {
                                        $like_button =
                                                '<img src="../buttons/like_button.png" height="20px" width="20px" "alt="Generic placeholder " width="10%" height="10%">';
                                    }
                                    ...
                                    if ($time < 60) {
										...
										$datetopost = date_create($show_time);
				
                                        $show_date = date_format($datetopost,"d M y");
                                    }

                                    if ($show_type == 'picture status'){
                                        $download_link = ' <a href="download_file_bridge.php?IN_status_id='.$post_imagestatus_id_array[$start].'&IN_post_type='.$show_type.'">' . $download_btn . '</a>';
                                    ...
                                    if ($show_type == 'picture status') {
                                        ...
                                        $show_image_post2 = '" alt="Generic placeholder " ></a>';
...
/*
                                        $cover_post_name = show_album_status($post_imagestatus_id_array[$start]);
                                        $show_image_post = '<img class="img-thumbnail col-md-10  col-sm-12 col-xs-12" src="../uploads/s/';
                                        $show_image_post2 = '" alt="Generic placeholder " width="140" height="140">';
                                        $cover_ = $show_image_post . $cover_post_name . $show_image_post2;

                                        $music_post_name = show_track_status($post_imagestatus_id_array[$start]);
                                        $music_post_type = show_track_type_status($post_imagestatus_id_array[$start]);
                                    ...
                                    echo         
                                    ' <div class="row table-border outside-border"><img class="img-circle pull-left" src="../uploads/images/' . show_pro_pic($posted_user_id) . '"  alt="Generic placeholder " width="40" height="40"><div class="pull-right"><font size="2px" color="#ccc">' . $show_date . '&nbsp;&nbsp;&nbsp;&nbsp;</font></div>
                                    ' . $display_link . '
...
' . $show_video_details . '
		 ...
		 '. $show_youtube . '
                                        ...
                                        <p><div  class="blog-text" style="max-width:900px; word-wrap:break-word;"><font size="3.5px">' . $show_text . '</font></div></p>
